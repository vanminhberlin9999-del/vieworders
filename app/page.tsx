...
export default function Home() {
  return (
    <div className="banner">
      <div className="flex min-h-screen w-full" style={{backgroundColor: '#EEF1F7'}}>
          <div className="container mx-autor flex flex-row justify-between items-center w-full">
              <div className="flex flex-col items-center w-full justify-center slider ">
                  <h1 className="font-heading text-h1 font-heading">Online Marketing & Web Design Agency Berlin</h1>
